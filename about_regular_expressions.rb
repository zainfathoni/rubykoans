...
class AboutRegularExpressions < Neo::Koan
  ...
  # Why?
  #
  # Because they will always match, even when nothing is there to match.
  ...
  #
  # A character class is a set of characters that can be matched, while alternation is a choice between two or more patterns.
