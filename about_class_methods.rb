...
class AboutClassMethods < Neo::Koan
  ...
  #
  # I prefer the first way because it is more readable and easier to understand.
  # The second way is more flexible and can be used to define multiple class methods at once.
  # The first way is more concise and easier to understand.
  # I would use the first way when I want to define only one class method.
  # I would use the second way when I want to define multiple class methods at once.
