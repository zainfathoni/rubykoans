...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # It's like a reduce function in other languages.
    # It takes an initial value and a block.
    # The block takes two arguments, the first is the accumulator and the second is the current element.
    # The block is called for each element in the array.
    # The return value of the block is the new accumulator value.
    # The final value of the accumulator is the return value of the inject method.
  end
  ...
  #
  # It's to limit the scope of the file variable.
